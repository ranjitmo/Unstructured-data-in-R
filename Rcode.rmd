...
path <- getwd()
crash_df <- read_csv( paste0(path, "/crash_data.csv") ) # reading in past 20 years worth of air accident data
...
So we are done here. It hasn't provided any amazing insight as such but we have been able to visualize crash locations across the world via bubbles where their size represents the number of fatalities. The key element was to get access to the data through webscraping and wrangle it into a format that can be easily displayed on a world map.
